/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc ./src/worker/worker-configuration.d.ts` (hash: 068904daaf065e4a8cc07534dc5b97c4)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "PUBLIC_WRITES_ENABLED" | "ACK_ANONYMOUS_PUBLIC_WRITES" | "ACK_RETAINED_IMAGE_METADATA" | "ACK_REACTIVE_PURGE_ONLY" | "OPERATOR_PREFLIGHT_TOKEN">> {}
}
