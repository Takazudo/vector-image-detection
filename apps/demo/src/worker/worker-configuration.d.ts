/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc ./src/worker/worker-configuration.d.ts` (hash: 3dbd1a1466df6738ba32b020161b0876)
// Runtime types generated with workerd@1.20260801.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	PHOTOS: R2Bucket;
	DB: D1Database;
	PHOTO_VECTORS: VectorizeIndex;
	PHOTO_QUEUE: Queue;
	PHOTO_DLQ: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "PUBLIC_WRITES_ENABLED" | "ACK_ANONYMOUS_PUBLIC_WRITES" | "ACK_RETAINED_IMAGE_METADATA" | "ACK_REACTIVE_PURGE_ONLY" | "OPERATOR_PREFLIGHT_TOKEN" | "AUTH_PASSWORD" | "AUTH_PASS_COOKIE">> {}
}
